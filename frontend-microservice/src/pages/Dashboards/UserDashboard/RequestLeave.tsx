...
const RequestLeave = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const daysOut = calculateDaysOut(leaveDetails.startDate, leaveDetails.endDate);
    const newLeaveEntry = {
      ...leaveDetails,
      daysOut,
    };
              ...
              <table className="table-auto w-full text-left border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-200">
                    ...
                    <th className="px-4 py-2 border border-gray-300">Days Out</th>
                ...
                <tbody>
                  {leaveHistory.map((leave, index) => (
                    <tr key={index}>
                      <td className="px-4 py-2 border border-gray-300">{leave.studentName}</td>
                      {/* <td className="px-4 py-2 border border-gray-300">{leave.roomNumber}</td> */}
                      <td className="px-4 py-2 border border-gray-300">{leave.startDate}</td>
                      <td className="px-4 py-2 border border-gray-300">{leave.endDate}</td>
                      <td className="px-4 py-2 border border-gray-300">{leave.daysOut}</td>

...
const UserProfile = () => {
  ...
  const removeHostel = (id) => {
    setBookmarkedHostels(bookmarkedHostels.filter((hostel) => hostel.id !== id));
  };
    ...
    <div className="min-h-screen p-0 ">
      <div className="w-full mx-auto rounded-xl overflow-hidden">
          ...
          <div className=" bg-orange-300 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-medium text-gray-700">{hostelInfo.name}</h3>
        ...
        <div className="p-6 bg-white rounded-xl">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Bookmarked Hostels</h2>
